...
<script type="text/javascript" src="themes/1hdshop/js/scrp.js"></script>
</head>
<body>
...
?>
 ...
 <div class="Header_cart">
	 <img src="themes/1hdshop/images/cart1.gif" />
   </div>
  <div class="blank"></div>
...
?>
            <tr>
              <td bgcolor="#ffffff" align="left" width="400">
...
?>
              ...
              <?php if ($this->_var['show_goods_attribute'] || $this->_var['show_goods_attribute'] == 1): ?>
              <td bgcolor="#ffffff" align="center" width="100"><?php echo nl2br($this->_var['goods']['goods_attr']); ?></td>
              <?php endif; ?>
              <?php if ($this->_var['show_marketprice']): ?>
              <td align="center" bgcolor="#ffffff" width="100" class="market_s"><?php echo $this->_var['goods']['market_price']; ?></td>
              <?php endif; ?>
              <td align="center" bgcolor="#ffffff" width="100"><?php echo $this->_var['goods']['goods_price']; ?></td>
        ...
        <a href="javascript:void(0);"  onclick="goods_cut('<?php echo $this->_var['goods']['rec_id']; ?>');" class="imgl"></a><input type="text" name="goods_number[<?php echo $this->_var['goods']['rec_id']; ?>]" onchange="document.getElementById('update_btn').click()" id="number<?php echo $this->_var['goods']['rec_id']; ?>" value="<?php echo $this->_var['goods']['goods_number']; ?>" size="4" class="inum" title="<?php echo $this->_var['lang']['goods_number_tip']; ?>"/><a href="javascript:void(0);"  onclick="goods_add('<?php echo $this->_var['goods']['rec_id']; ?>');" class="imgr"></a></div>
              ...
              <td align="center" bgcolor="#ffffff" width="100" class="f1 f5"><?php echo $this->_var['goods']['subtotal']; ?></td>
              <td align="center" bgcolor="#ffffff" width="100">
            ...
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
             ...
             <td colspan="7">
					...
					<td bgcolor="#ffffff"><input type="button" value=" " class="cartl" onclick="location.href='flow.php?step=clear'" /><input name="submit" type="submit" id="updatecart" value="<?php echo $this->_var['lang']['update_cart']; ?>" class="none"/>
					  </td>
					  <td align="right" bgcolor="#ffffff">
						  <?php if ($this->_var['discount'] > 0): ?><?php echo $this->_var['your_discount']; ?><?php endif; ?>
					      <font class="catrf1"><b>应付总额</b>(不含运费)</font>：<font class="fcart2"><?php echo $this->_var['shopping_money']; ?></font>
					  </td>	
				  </table>
             </td>
             </tr> 
        ...
        <table width="100%" align="center" border="0" cellpadding="5" cellspacing="0" bgcolor="#dddddd">
          <tr>
            ...
            <td bgcolor="#ffffff" align="right"> <a href="flow.php?step=checkout"><img src="themes/1hdshop/images/checkout.gif" alt="checkout" /></a></td>
          </tr>
        </table>
...
?>
        <div class="fittg">
         ...
         <a href="javascript:fittings_to_flow(<?php echo $this->_var['fittings']['goods_id']; ?>,<?php echo $this->_var['fittings']['parent_id']; ?>)"><img src="themes/1hdshop/images/bnt_buy.gif" alt="<?php echo $this->_var['lang']['collect_to_flow']; ?>" /></a>
		  </div>
        </div> 
        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
      </div>    
...
?><br />
            ...
            <tr>
              ...
              <td align="center" bgcolor="#ffffff"><input type="image" src="themes/1hdshop/images/bnt_cat.gif" alt="Add to cart"  border="0" /></td>
            </tr>
            <?php endif; ?>
          </table>
...
?>
        ...
        <div class="Header_cart">
	    <img src="themes/1hdshop/images/cart2.gif" />
      </div>
       <div class="blank"></div>
...
?>
     ...
     <div class="blank"></div>
       <div class="flowBox">
        <h6><span><?php echo $this->_var['lang']['goods_list']; ?></span><?php if ($this->_var['allow_edit_cart']): ?><a href="flow.php" class="f6">[返回购物车修改]</a><?php endif; ?></h6>
        <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#F9F9F9">
            <tr>
...
?>
      ...
      <div class="blank"></div>
      <div class="flowBox">
      <h6><span><?php echo $this->_var['lang']['consignee_info']; ?></span><a href="flow.php?step=consignee" class="f6">[修改收货人信息]</a></h6>
      <table width="99%" align="center" border="0" cellpadding="5" cellspacing="2">
            <tr>
              <td bgcolor="#ffffff" align="right"><?php echo $this->_var['lang']['consignee_name']; ?>:</td>
            ...
            <tr>
              <td bgcolor="#ffffff" align="right"><?php echo $this->_var['lang']['detailed_address']; ?>:</td>
              <td bgcolor="#ffffff"><?php echo htmlspecialchars($this->_var['consignee']['address']); ?> </td>
              <td bgcolor="#ffffff" align="right"><?php echo $this->_var['lang']['postalcode']; ?>:</td>
              <td bgcolor="#ffffff"><?php echo htmlspecialchars($this->_var['consignee']['zipcode']); ?></td>
            </tr>
            <?php endif; ?>
            <tr>
              <td bgcolor="#ffffff" align="right"><?php echo $this->_var['lang']['phone']; ?>:</td>
              <td bgcolor="#ffffff"><?php echo $this->_var['consignee']['tel']; ?> </td>
              <td bgcolor="#ffffff" align="right"><?php echo $this->_var['lang']['backup_phone']; ?>:</td>
              <td bgcolor="#ffffff"><?php echo htmlspecialchars($this->_var['consignee']['mobile']); ?></td>
            </tr>
             <?php if ($this->_var['total']['real_goods_count'] > 0): ?>
            <tr>
              <td bgcolor="#ffffff" align="right"><?php echo $this->_var['lang']['sign_building']; ?>:</td>
              <td bgcolor="#ffffff"><?php echo htmlspecialchars($this->_var['consignee']['sign_building']); ?> </td>
              <td bgcolor="#ffffff" align="right"><?php echo $this->_var['lang']['deliver_goods_time']; ?>:</td>
    ...
    <div class="flowBox">
    <h6><span>配送与付款方式</span></h6>
        <?php if ($this->_var['total']['real_goods_count'] != 0): ?>
        <div class="psfs"><div class="title">配送方式</div></div>
    <table width="90%" align="center" border="0" cellpadding="0" cellspacing="0" id="shippingTable">
            <?php $_from = $this->_var['shipping_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'shipping');if (count($_from)):
    foreach ($_from AS $this->_var['shipping']):
?>
            <tr>
              <td width="3%"><input name="shipping" type="radio" value="<?php echo $this->_var['shipping']['shipping_id']; ?>" <?php if ($this->_var['order']['shipping_id'] == $this->_var['shipping']['shipping_id']): ?>checked="true"<?php endif; ?> supportCod="<?php echo $this->_var['shipping']['support_cod']; ?>" insure="<?php echo $this->_var['shipping']['insure']; ?>" onclick="selectShipping(this)" />
              </td>
              <td><?php echo $this->_var['shipping']['shipping_name']; ?></td>
              <td style="color:#BEBCBC"><?php echo $this->_var['shipping']['shipping_desc']; ?></td>
              <td  align="right">费用：<font class="f7"><?php echo $this->_var['shipping']['format_shipping_fee']; ?></font></td>
            </tr>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
            <tr>
              <td colspan="4" align="right"><label for="ECS_NEEDINSURE">
        ...
        <?php endif; ?>
            <div class="flowBoxc">
     <div class="psfs"><div class="title">付款方式</div></div>
    <table width="90%" align="center" border="0" cellpadding="0" cellspacing="0" id="paymentTable">
            <tr>
              <th colspan="6" style="height:8px;"></th>
            </tr>
...
?>
            ...
            <tr>
              ...
              <td width="10%"><strong><?php echo $this->_var['payment']['pay_name']; ?></strong></td>
              <td><div class="pflow10"><?php echo $this->_var['payment']['pay_desc']; ?></div></td>
              <td><div class="pflow10"><?php echo $this->_var['payment']['format_pay_fee']; ?></div></td>
            </tr>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
            <tr>
              <th colspan="6" style="height:8px;"></th>
    ...
    <div class="blank"></div>
          ...
          <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#F9F9F9" id="packTable">
            <tr>
...
?>
          ...
          <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#F9F9F9" id="cardTable">
            <tr>
...
?>
                ...
                <input name="validate_bonus" type="button" class="bnt_blue_1" value="<?php echo $this->_var['lang']['validate_bonus']; ?>" onclick="validateBonus(document.forms['theForm'].elements['bonus_sn'].value)" />
              </td>
            </tr>
            <?php endif; ?>
...
?>
    ...
    <div class="blank"></div>
     <img src="themes/1hdshop/images/order_total.gif">
     <div class="flowBoxtotal">
          <?php echo $this->fetch('library/order_total.lbi'); ?>
           <div align="center" style="margin:8px auto;">
            <input type="image" src="themes/1hdshop/images/bnt_subOrder.gif" />
        ...
        <?php if ($this->_var['step'] == "done"): ?>
         ...
         <div class="Header_cart">
	 <img src="themes/1hdshop/images/cart3.gif" />
   </div>
  <div class="blank"></div>
        ...
        <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#ffffff">
          <tr>
            ...
            <form action="flow.php?step=login" method="post" name="loginForm" id="loginForm" onsubmit="return checkLoginForm(this)">
                <table width="90%" border="0" cellpadding="8" cellspacing="1" bgcolor="#ffffff" class="table">
                  <tr>
            ...
            <td bgcolor="#ffffff"><input type="checkbox" value="1" name="remember" id="remember" /><label for="remember"><?php echo $this->_var['lang']['remember']; ?></label></td>
                  ...
                  <tr>
                    ...
                    <td bgcolor="#ffffff">
				     ...
				     <tr>
					<td bgcolor="#ffffff"></td>
				    <td bgcolor="#ffffff">您可以用合作伙伴账号登录：</td>
                  </tr>
				   <tr>
				   <td bgcolor="#ffffff"></td>
                    <td bgcolor="#ffffff">
                        <a href="api/qqconnect/interface.php"><img src="themes/1hdshop/images/login1.gif" /></a> <a href="alipayLogin/auth_authorize.php?type=user"><img src="themes/1hdshop/images/login2.gif" /></a>
                     </td>
                  </tr>
				  <tr>
				  <td bgcolor="#ffffff"></td>
            ...
            <form action="flow.php?step=login" method="post" name="formUser" id="registerForm" onsubmit="return checkSignupForm(this)">
               <table width="98%" border="0" cellpadding="8" cellspacing="1" bgcolor="#ffffff" class="table">
                  <tr>
...
<?php echo $this->fetch('library/u_footer.lbi'); ?>
</body>
<script type="text/javascript">
