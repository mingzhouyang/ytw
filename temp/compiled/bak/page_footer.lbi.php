...
<dt><?php echo $this->_var['help_cat']['cat_name']; ?></dt>
         <?php $_from = $this->_var['help_cat']['article']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'item_0_36134000_1373967521');if (count($_from)):
    foreach ($_from AS $this->_var['item_0_36134000_1373967521']):
?>
           <dd><a href="<?php echo $this->_var['item_0_36134000_1373967521']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['item_0_36134000_1373967521']['title']); ?>"><?php echo $this->_var['item_0_36134000_1373967521']['short_title']; ?></a></dd>
...
<p> <?php if ($this->_var['navigator_list']['bottom']): ?>
               <?php $_from = $this->_var['navigator_list']['bottom']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'nav_0_36205100_1373967521');$this->_foreach['nav_bottom_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['nav_bottom_list']['total'] > 0):
    foreach ($_from AS $this->_var['nav_0_36205100_1373967521']):
        $this->_foreach['nav_bottom_list']['iteration']++;
?>
                   <a href="<?php echo $this->_var['nav_0_36205100_1373967521']['url']; ?>" <?php if ($this->_var['nav_0_36205100_1373967521']['opennew'] == 1): ?> target="_blank" <?php endif; ?>><?php echo $this->_var['nav_0_36205100_1373967521']['name']; ?></a>
