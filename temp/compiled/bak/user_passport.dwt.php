				...
				<form name="formLogin" action="user.php" method="post" onsubmit="return userLogin()">
	            	<div class="login_left">
	                	<div class="login_form2">
	                        ...
	                        <p>
	                        	<label>密码:</label>
	                        	<input name="password" class="inputBg input" type="password">
                        	</p>
	                        ...
	                        <p class="butt">
                                 ...
                                 <input type="hidden" name="back_act" value="<?php echo $this->_var['back_act']; ?>" />
	                       		 ...
	                       		 <a href="user.php?act=get_password" class="ml10" style="color:#0066CC">忘记密码？</a>
	                        </p>

	                    </div>
	                    <div class="other_login">
	                        <p>您可以用合作伙伴账号登录：</p>
                            <p><a href="api/qqconnect/interface.php"><img src="themes/1hdshop/images/login1.gif" /></a> <a href="alipayLogin/auth_authorize.php?type=user"><img src="themes/1hdshop/images/login2.gif" /></a></p>								 
	                	</div>
	                </div>
                </form>
	                ...
	                <div class="regist_right">
	                    ...
	                    <p class="tc"><a href="user.php?act=register"><img src="themes/1hdshop/images/bnt_ur_reg1.gif" /></a></p>
	                </div>
                <div class="blank"></div>
            </div>
