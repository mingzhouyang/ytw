...
?>
     <dl>
     <dt><div <?php if ($this->_var['cat_id'] == $this->_var['child']['id']): ?>class="chov"<?php else: ?>class="clink"<?php endif; ?>><a href="<?php echo $this->_var['child']['url']; ?>"><?php echo htmlspecialchars($this->_var['child']['name']); ?></a></div></dt>
...
?>
     <dd><div <?php if ($this->_var['cat_id'] == $this->_var['childer']['id']): ?>class="d2hov"<?php else: ?>class="d2link"<?php endif; ?>><a href="<?php echo $this->_var['childer']['url']; ?>"><?php echo htmlspecialchars($this->_var['childer']['name']); ?></a></div></dd>
...
<?php echo $this->fetch('library/goods_attrlinked.lbi'); ?>
 ...
 <?php echo $this->fetch('library/history.lbi'); ?>
  ...
  <div class="AreaR">
   ...
   <div class="goodstitle"><?php echo $this->_var['goods']['goods_style_name']; ?> <font class="brief"><?php echo $this->_var['goods']['goods_brief']; ?></font></div>
     
     <div class="imgInfo">
	  <?php if ($this->_var['pictures']['0']['img_url']): ?>
    <a href="<?php echo $this->_var['pictures']['0']['img_url']; ?>" id="Zoomer" class="MagicZoomPlus" rel="selectors-effect:false;zoom-fade:true;background-opacity:70;zoom-width:350;zoom-height:350;caption-source:img:title;thumb-change:mouseover" title=""  onclick="window.open('gallery.php?id=<?php echo $this->_var['goods']['goods_id']; ?>'); return false;">
    <img id="img_url" src="<?php echo $this->_var['pictures']['0']['img_url']; ?>" alt="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>" class="thumb" />
    </a>
    <?php else: ?>
    ...
    <?php endif; ?>
     ...
     <?php echo $this->fetch('library/goods_gallery.lbi'); ?>
         ...
         <div class="blank5"></div>
		 <div class="f_l"><a href="#" onclick="window.open('gallery.php?id=<?php echo $this->_var['goods']['goods_id']; ?>'); return false;" target="_blank"><img src="themes/1hdshop/images/zoomimg.gif" /></a></div> 
...
document.getElementById("bdshell_js").src = "http://bdimg.share.baidu.com/static/js/shell_v2.js?cdnversion=" + Math.ceil(new Date()/3600000);
     ...
     <div class="info">
	  ...
	  <?php else: ?>
	  	  <li class="clearfix"> 
        <?php echo $this->_var['lang']['shop_price']; ?><font class="shopprice" id="ECS_SHOPPRICE"><?php echo $this->_var['goods']['shop_price_formated']; ?> </font>   
      </li>
      ...
      <li class="clearfix">
       ...
       <?php echo $this->_var['lang']['market_price']; ?><font class="market"><?php echo $this->_var['goods']['market_price']; ?></font>
       <?php endif; ?> &nbsp;&nbsp;<?php if ($this->_var['goods']['is_promote'] && $this->_var['goods']['gmt_end_time']): ?>促销期间折扣：<?php echo $this->_var['goods']['cuxiao_zhekou_price']; ?>折  节省：<?php echo $this->_var['goods']['cuxiao_sheng_price']; ?></font> <?php else: ?>折扣：<?php echo $this->_var['goods']['zhekou_price']; ?> 折  节省：<?php echo $this->_var['goods']['sheng_price']; ?> <?php endif; ?> 
      </li>
...
?>
      ...
      <?php endif; ?> 
       ...
       <?php echo $this->_var['lang']['goods_brand']; ?><a href="<?php echo $this->_var['goods']['goods_brand_url']; ?>" style="color:#0068AE"><?php echo $this->_var['goods']['goods_brand']; ?></a>
       <?php endif; ?>&nbsp;&nbsp;&nbsp;&nbsp;
...
?>
      ...
      <?php endif; ?>  
	    ...
	    <li class="clearfix">
       <?php echo $this->_var['lang']['goods_rank']; ?><img src="themes/1hdshop/images/stars<?php echo $this->_var['goods']['comment_rank']; ?>.gif" alt="comment rank <?php echo $this->_var['goods']['comment_rank']; ?>" /> <a href="#pl" style="color:#0068AE">(已有<?php 
$k = array (
  'name' => 'pl_sum',
...
?>人评价)</a>
	  ...
	  <li class="clearfix">
        库　　存：<?php if ($this->_var['goods']['goods_number'] == 0): ?>
          该商品缺货
        <?php else: ?>
          有货
        <?php endif; ?>
...
?>
                       <li style="border:0px;">
  <a onclick="changeP('spec_<?php echo $this->_var['spec_key']; ?>','<?php echo $this->_var['value']['id']; ?>')" name="sp_url_<?php echo $this->_var['spec_key']; ?>" id="url_<?php echo $this->_var['value']['id']; ?>"  title="<?php if ($this->_var['value']['price'] > 0): ?><?php echo $this->_var['lang']['plus']; ?><?php elseif ($this->_var['value']['price'] < 0): ?><?php echo $this->_var['lang']['minus']; ?><?php endif; ?> <?php echo $this->_var['value']['format_price']; ?>" <?php if ($this->_var['key'] == 0): ?>class="selected"<?php endif; ?>><?php echo $this->_var['value']['label']; ?><input style="display:none" id="spec_value_<?php echo $this->_var['value']['id']; ?>" type="radio" name="spec_<?php echo $this->_var['spec_key']; ?>" value="<?php echo $this->_var['value']['id']; ?>" <?php if ($this->_var['key'] == 0): ?>checked<?php endif; ?> /></a>
                      </li>
                      <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                      </ul>
					  </div>
...
?>
      ...
      <a href="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>)"><img src="themes/1hdshop/images/bnt_cat.gif" /></a>&nbsp;
      <a href="javascript:collect(<?php echo $this->_var['goods']['goods_id']; ?>)"><img src="themes/1hdshop/images/bnt_colles.gif" /></a>
      </div>
	  </div>
	  <div class="blank"></div>
...
?>
          ...
          <td bgcolor="#FFFFFF">
          <a href="javascript:addPackageToCart(<?php echo $this->_var['package_goods']['act_id']; ?>)" style="background:transparent"><img src="themes/1hdshop/images/bnt_buy_1.gif" alt="<?php echo $this->_var['lang']['add_to_cart']; ?>" /></a>
          </td>
        </tr>
       </table>
       <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
