...
.compose .cp_tit{float:left;width:90px;font-size:12px; height:31px; background:url(themes/1hdshop/images/zhg1.gif) no-repeat;}
.compose .cp_tit span
{
...
.cp_box .main_pro{float:left;width:170px;padding-top:5px;background:url(themes/1hdshop/images/ico_add_zh.gif) no-repeat right center;text-align:left;display:ineline;}
...
.cp_box .cp_price .cp_input{
	...
	background:url(themes/1hdshop/images/zhg2.gif) no-repeat;
