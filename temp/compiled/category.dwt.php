...
?>
			...
			<?php endif; ?>
			<?php $_from = $this->_var['filter_attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'filter_attr_0_66316600_1408588154');if (count($_from)):
    foreach ($_from AS $this->_var['filter_attr_0_66316600_1408588154']):
?>
      <div class="screeBox">
           <div class="screeBoxs">
			<?php echo htmlspecialchars($this->_var['filter_attr_0_66316600_1408588154']['filter_attr_name']); ?>：
			<?php $_from = $this->_var['filter_attr_0_66316600_1408588154']['attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'attr');if (count($_from)):
