...
<table cellspacing="1" cellpadding="3" width="100%">
  <tr>
    ...
    <td><select name="cat_id"><option value="0"><?php echo $this->_var['lang']['all_category']; ?></caption><?php echo $this->_var['cat_list']; ?></select><?php echo $this->_var['lang']['require_field']; ?></td>
  </tr>
  <tr>
    <td class="label">显示类型</td>
    <td><input type="radio" name="pclassid" value="1" <?php if ($this->_var['brand']['pclassid'] == 1): ?>checked="checked"<?php endif; ?> /> 幻灯片(550-175)
        <input type="radio" name="pclassid" value="2" <?php if ($this->_var['brand']['pclassid'] == 2): ?>checked="checked"<?php endif; ?> /> 滚动图片(120-140)
        <input type="radio" name="pclassid" value="3" <?php if ($this->_var['brand']['pclassid'] == 3): ?>checked="checked"<?php endif; ?> /> 右侧广告(273-123)
    </td>
  </tr>
    <tr>
    <td class="label"></td>
  ...
  <tr>
    ...
    <td><input type="file" name="brand_logo" id="logo" size="45"><?php if ($this->_var['brand']['brand_logo'] != ""): ?><input type="button" value="<?php echo $this->_var['lang']['drop_brand_logo']; ?>" onclick="if (confirm('<?php echo $this->_var['lang']['confirm_drop_logo']; ?>'))location.href='ecy_classpic.php?act=drop_logo&id=<?php echo $this->_var['brand']['brand_id']; ?>'"> <?php echo $this->_var['brand_logo']; ?><?php endif; ?>
