...
?>
  <tr>
    ...
    <td align="left"><span><?php echo $this->_var['list']['type']; ?></span> <a href="../data/afficheimg/<?php echo $this->_var['list']['ad_code']; ?>" target="_blank"><img src="images/picflag.gif" border="0" /><img src="../data/afficheimg/<?php echo $this->_var['list']['ad_code']; ?>" border="0" width="50" /></a></td>
