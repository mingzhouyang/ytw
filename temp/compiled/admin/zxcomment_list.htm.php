...
<form method="POST" action="zxcomment_manage.php?act=batch_drop" name="listForm" onsubmit="return confirm_bath()">
...
?>
  <tr>
    ...
    <td><?php echo sub_str($this->_var['comment']['content'],10); ?></td>
    <td><?php echo $this->_var['comment']['ip_address']; ?></td>
    <td align="center"><?php echo $this->_var['comment']['add_time']; ?></td>
    <td align="center"><?php if ($this->_var['comment']['status'] == 0): ?><font color="#ff0000"><?php echo $this->_var['lang']['hidden']; ?></font><?php else: ?><?php echo $this->_var['lang']['display']; ?><?php endif; ?></td>
    <td align="center">
      <a href="zxcomment_manage.php?act=reply&amp;id=<?php echo $this->_var['comment']['comment_id']; ?>"><?php echo $this->_var['lang']['view_content']; ?></a> |
