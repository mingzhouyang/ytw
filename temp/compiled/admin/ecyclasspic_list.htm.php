...
?>
    <tr>
      ...
      <td>
      <?php if ($this->_var['brand']['pclassid'] == 1): ?>幻灯片(550-175)<?php endif; ?>
      <?php if ($this->_var['brand']['pclassid'] == 2): ?>滚动图片(120-140)<?php endif; ?>
      <?php if ($this->_var['brand']['pclassid'] == 3): ?>右侧广告(273-123)<?php endif; ?>
      </td>
      <td class="first-cell">
