...
FCKConfig.ToolbarSets["Default"] = [
	['Source','savehttpfiles','DocProps','-','Save','NewPage','Preview','-','Templates'],
	...
	['Link','Unlink','Anchor'],
	['Image','swfupload','Flash','UpFileBtn','Table','Rule','Smiley','SpecialChar','PageBreak'],
	'/',
...
FCKConfig.ToolbarSets["Normal"] = [
  ...
  ['Link','Unlink','-','Image','swfupload','Flash','UpFileBtn','Table'],
