...
if (!$smarty->is_cached('category.dwt', $cache_id))
{
	...
	$smarty->assign('ecy_adflash', get_ecy_classpic($cat_id,1));
	$smarty->assign('ecy_adflash1', get_ecy_classpic($cat_id,2));
	$smarty->assign('ecy_adflash2', get_ecy_classpic($cat_id,3));
